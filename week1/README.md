...
Modified refactored code will be uploaded to [Week1 Folder](modifiedcode). The folder includes [modified CSS](modifiedcode/Develop/assets/css/style.css) and [modified semantic html](modifiedcode/Develop/index.html) and [markdown file](modifiedcode/README.md) that explains modificatins done to make the code more accessbile.
